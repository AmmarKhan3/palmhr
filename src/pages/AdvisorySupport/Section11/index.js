...
import pic1 from "src/images/feature6-time-manage.svg";
import pic2 from "src/images/feature6-compensation.svg";
import pic3 from "src/images/feature6-talent.svg";
        ...
        <div className="offerBox">
          ...
          <div className="offerBoxDiv1">
            ...
            <div className="offerimg1">
              <img src={data[0]?.Url} className=""  alt="Advisory Icon" />
            </div>
          ...
          <div className="offerBoxDiv2">
            ...
            <div className="offerimg2">
              <img src={data[1]?.Url} className="" alt="Advisory Icon"  />
            </div>
            <button className="card-btn">
              <p className="btn-text">See More</p>
            </button>
          ...
          <div className="offerBoxDiv1">
            ...
            <div className="offerimg3">
              <img src={data[2]?.Url} className=""  alt="Advisory Icon" />
            </div>
            <button className="card-btn">
              <p className="btn-text">See More</p>
            </button>
