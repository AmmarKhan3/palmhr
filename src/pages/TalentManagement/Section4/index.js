...
import { data } from "src/Data/Section4";
import img from "src/images/feature4-zero.svg";
import img_mbl from "src/images/feature4-zero-mbl.svg";
  ...
  return (
    <div>
      <div className="mobile11">
        <p className="main-heading">Talent Management</p>
